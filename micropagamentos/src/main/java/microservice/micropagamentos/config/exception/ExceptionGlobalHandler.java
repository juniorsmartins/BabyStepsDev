...
import microservice.micropagamentos.config.exception.http_404.RecursoNotFoundException;
import microservice.micropagamentos.config.exception.http_409.BusinessRuleViolationException;
import microservice.micropagamentos.config.exception.http_500.InternalServerFailureException;
