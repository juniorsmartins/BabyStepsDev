...
@DisplayName("Unit NoticiaUpdateDtoIn - Notícia")
class NoticiaUpdateDtoInUnitTest {
    ...
    private NoticiaUpdateDtoIn.NoticiaUpdateDtoInBuilder noticiaUpdateDtoInBuilder;

    @BeforeEach
    void setUp() {
        noticiaUpdateDtoInBuilder = factory.gerarNoticiaUpdateDtoInBuilder();
        noticiaUpdateDtoInBuilder.id(1001L);
    }

    @Test
    @DisplayName("notícia válida")
    void dadoNoticiaValida_QuandoInstanciar_EntaoRetornarDtoIn() {
        var dtoIn = noticiaUpdateDtoInBuilder.build();
        Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
    ...
    class Id {
        ...
        @Test
        @DisplayName("nulo")
        void dadoIdNulo_QuandoInstanciar_EntaoLancarException() {
            var dtoIn = noticiaUpdateDtoInBuilder.id(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
        ...
        @DisplayName("negativo e zero")
        void dadoChapeuNulo_QuandoInstanciar_EntaoLancarException(Long id) {
            var dtoIn = noticiaUpdateDtoInBuilder.id(id).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
            Assertions.assertEquals(1, violations.size());
        }
    ...
    class Chapeu {
        ...
        void dadoChapeuNulo_QuandoInstanciar_EntaoLancarException() {
            var dtoIn = noticiaUpdateDtoInBuilder.chapeu(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
            Assertions.assertEquals(1, violations.size());
        }
        ...
        void dadoChapeuVazioOuEmBranco_QuandoInstanciar_EntaoLancarException(String valor) {
            var dtoIn = noticiaUpdateDtoInBuilder.chapeu(valor).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
        }
    ...
    class Titulo {
        ...
        void dadoTituloNulo_QuandoInstanciar_EntaoLancarException() {
            var dtoIn = noticiaUpdateDtoInBuilder.titulo(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
            Assertions.assertEquals(1, violations.size());
        }
        ...
        void dadoTituloVazioOuEmBranco_QuandoInstanciar_EntaoLancarException(String valor) {
            var dtoIn = noticiaUpdateDtoInBuilder.titulo(valor).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
        }
    ...
    class LinhaFina {
        ...
        void dadoLinhaFinaNulo_QuandoInstanciar_EntaoLancarException() {
            var dtoIn = noticiaUpdateDtoInBuilder.linhaFina(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
            Assertions.assertEquals(1, violations.size());
        }
        ...
        void dadoLinhaFinaVazioOuEmBranco_QuandoInstanciar_EntaoLancarException(String valor) {
            var dtoIn = noticiaUpdateDtoInBuilder.linhaFina(valor).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
        }
    ...
    class Lide {
        ...
        void dadoLideNulo_QuandoInstanciar_EntaoLancarException() {
            var dtoIn = noticiaUpdateDtoInBuilder.lide(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
            Assertions.assertEquals(1, violations.size());
        }
        ...
        void dadoLideVazioOuEmBranco_QuandoInstanciar_EntaoLancarException(String valor) {
            var dtoIn = noticiaUpdateDtoInBuilder.lide(valor).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
        }
    ...
    class Corpo {
        ...
        void dadoCorpoNulo_QuandoInstanciar_EntaoLancarException() {
            var dtoIn = noticiaUpdateDtoInBuilder.corpo(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
            Assertions.assertEquals(1, violations.size());
        }
        ...
        void dadoCorpoVazioOuEmBranco_QuandoInstanciar_EntaoLancarException(String valor) {
            var dtoIn = noticiaUpdateDtoInBuilder.corpo(valor).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
        }
    ...
    class Autorias {
        ...
        void dadoAutoriasNulo_QuandoInstanciar_EntaoRetornarDtoIn() {
            var dtoIn = noticiaUpdateDtoInBuilder.autorias(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertTrue(violations.isEmpty());
        }
        ...
        void dadoAutoriasComValoresVaziosOuEmBranco_QuandoInstanciar_EntaoLancarException(String valor) {
            var dtoIn = noticiaUpdateDtoInBuilder.autorias(List.of(valor)).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
        }
    ...
    class Fontes {
        ...
        void dadoFontesNulo_QuandoInstanciar_EntaoRetornarDtoIn() {
            var dtoIn = noticiaUpdateDtoInBuilder.fontes(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertTrue(violations.isEmpty());
        }
        ...
        void dadoFontesComValoresVaziosOuEmBranco_QuandoInstanciar_EntaoLancarException(String valor) {
            var dtoIn = noticiaUpdateDtoInBuilder.fontes(List.of(valor)).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertFalse(violations.isEmpty());
        }
    ...
    class Editorias {
        ...
        void dadoEditoriasNulo_QuandoInstanciar_EntaoRetornarDtoIn() {
            var dtoIn = noticiaUpdateDtoInBuilder.editorias(null).build();
            Set<ConstraintViolation<NoticiaUpdateDtoIn>> violations = validator.validate(dtoIn);
            Assertions.assertTrue(violations.isEmpty());
        }
    }
