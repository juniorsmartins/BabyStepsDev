...
import microservice.microtorneios.application.core.usecase.SagaEventFailUseCase;
...
public class SagaEventConfig {
    ...
    @Bean
    public SagaEventSuccessUseCase sagaEventSuccessUseCase(MapperIn mapperIn, JsonUtil jsonUtil,
    ...
    @Bean
    public SagaEventFailUseCase sagaEventFailUseCase(MapperIn mapperIn, JsonUtil jsonUtil,
                                                 TorneioFindAdapter torneioFindAdapter,
                                                 TorneioSaveAdapter torneioSaveAdapter,
                                                 CarteiroNotifyOrchestratorProducer carteiroNotifyOrchestratorProducer) {
        return new SagaEventFailUseCase(mapperIn, jsonUtil, torneioFindAdapter, torneioSaveAdapter,
                carteiroNotifyOrchestratorProducer);
    }
}
